"""Render the retention dashboard to a self-contained HTML file.
...
def render(data: dict) -> str:
    ...
    return f"""<!-- generated by dashboard/build.py -->
<title>Frame Shop Retention</title>
<meta name="description" content="Monthly and quarterly customer-retention KPIs for the framing store.">
